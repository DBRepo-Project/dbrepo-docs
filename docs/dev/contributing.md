...
<figure markdown>
![Branching strategy from the master-dev-feature branches and release branches](/infrastructures/dbrepo/1.12/images/branching-strategy.svg)
</figure>
...
<figure markdown>
![Gitlab runner configuration in the cluster](/infrastructures/dbrepo/1.12/images/gitlab-runner.png)
</figure>
