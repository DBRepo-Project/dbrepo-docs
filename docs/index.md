...
Documentation for version: [v1.13.4](https://gitlab.phaidra.org/fair-data-austria-db-repository/fda-services/-/releases) (as [PDF](/infrastructures/dbrepo/dbrepo_v1.13.3.pdf)). 
