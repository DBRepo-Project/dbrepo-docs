...
[:fontawesome-solid-database: &nbsp;Dataset](https://dbrepo.datalab.tuwien.ac.at/database/14daff7e-9dae-4ba0-9887-6ded15572c4e){ .md-button .md-button--primary target="_blank" }
...
<figure markdown>
![](/infrastructures/dbrepo/1.10/images/screenshots/power.png)
...
We connected our [Broker Service](/infrastructures/dbrepo/1.10/api/broker-service) with the MQTT broker of the Pilotfabrik using a self-written
...
<img src="/infrastructures/dbrepo/1.10/images/logos/ift.jpeg" width=100 />
