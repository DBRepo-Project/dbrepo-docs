...
!!! debug "Debug Information"
    ...
    Image: [`registry.datalab.tuwien.ac.at/dbrepo/metadata-service:1.10.3`](https://hub.docker.com/r/dbrepo/metadata-service)
...
The metadata service manages metadata of identities, the [Broker Service](/infrastructures/dbrepo/1.10/broker-service) (i.e. obtaining queue
...
services:
  dbrepo-metadata-service:
    image: registry.datalab.tuwien.ac.at/dbrepo/metadata-service:1.10.3
    environment:
...
the [Metadata Database](/infrastructures/dbrepo/1.10/dev/services/metadata-db) from registered ontologies
