...
Documentation for version: [v1.13.3](https://gitlab.phaidra.org/fair-data-austria-db-repository/fda-services/-/releases) as [PDF](/infrastructures/dbrepo/1.13.3/dbrepo.pdf). 
