...
!!! debug "Debug Information"
    ...
    Image: [`bitnami/rabbitmq:3.13.7`](https://hub.docker.com/r/bitnamilegacy/rabbitmq)
...
[Identity Service](identity-service) to access the Broker Service as user with
...
1. Once you change the admin password of the [Identity Service](identity-service),
