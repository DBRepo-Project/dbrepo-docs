...
This service communicates between the Search Database and the [User Interface](/infrastructures/dbrepo/dev/services/ui)
...
<figure markdown>
![Built-in search](/infrastructures/dbrepo/images/screenshots/feature-search.png)
</figure>
...
<figure markdown>
![Mirroring statistical properties in Metadata Database and Search Database](/infrastructures/dbrepo/images/statistics-mirror.png)
</figure>
...
For example, the [User Interface](/infrastructures/dbrepo/dev/services/ui/) allows for the search of databases that contain a certain
