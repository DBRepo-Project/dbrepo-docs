...
-   :material-kubernetes:{ .lg .middle } **Install on Kubernetes**
    ...
    [:octicons-arrow-right-24: Getting started](install-kubernetes)
...
-   :material-docker:{ .lg .middle } **Install on Docker**
    ...
    [:octicons-arrow-right-24: Getting started](install-docker)
...
-   :material-remote-desktop:{ .lg .middle } **Install on VM**
    ...
    [:octicons-arrow-right-24: Getting started](install-vm)
...
-   :material-wrench:{ .lg .middle } **Build from Sourcecode**
    ...
    [:octicons-arrow-right-24: Getting started](build-source)
