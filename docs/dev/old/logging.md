...
forward logs to the [Search Database](/infrastructures/dbrepo/1.12/dev/services//search-db/).

!!! info "Only available in the Kubernetes deployment"

## Collection

The [Data Service](/infrastructures/dbrepo/1.12/dev/services//data-service/) and [Metadata Service](/infrastructures/dbrepo/1.12/dev/services//metadata-service/) use Slf4j as logging
...
After parsing, the logs are sent to the [Search Database](/infrastructures/dbrepo/1.12/dev/services//search-db/) where they are stored as documents in
the index `logging`.
...
![Grafana dashboard showing log frequency and detail](/infrastructures/dbrepo/1.12/images/screenshots/dashboard_ops-logs.png)
========
