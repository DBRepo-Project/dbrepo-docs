...
This service communicates between the Search Database and the [User Interface](/infrastructures/dbrepo/1.12/dev/services/ui)
...
<figure markdown>
![Built-in search](/infrastructures/dbrepo/1.12/images/screenshots/feature-search.png)
</figure>
...
<figure markdown>
![Mirroring statistical properties in Metadata Database and Search Database](/infrastructures/dbrepo/1.12/images/statistics-mirror.png)
</figure>
...
For example, the [User Interface](/infrastructures/dbrepo/1.12/dev/services/ui/) allows for the search of databases that contain a certain
